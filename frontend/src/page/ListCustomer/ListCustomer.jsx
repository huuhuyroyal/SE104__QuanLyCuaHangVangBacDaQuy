...
import { Table, Input, Button, Modal, Form, message, Space, Card, Tag } from "antd";
import { PlusOutlined, DeleteOutlined, SearchOutlined, EyeOutlined, ExportOutlined } from "@ant-design/icons";
...
const CustomerList = () => {
  ...
  const handleDelete = (id) => {
    Modal.confirm({
      ...
      content: "Hành động này sẽ xóa toàn bộ lịch sử hóa đơn liên quan đến khách hàng này.",
      okText: "Xóa",
      okType: "danger",
      cancelText: "Hủy",
      onOk: async () => {
      ...
      <div className="customer-page-container">
        <Card className="customer-card">
          <div className="customer-header-actions">
            ...
            />
            <Space>
              <Button icon={<ExportOutlined />} className="btn-export">Xuất file</Button>
              <Button
                type="primary"
                icon={<PlusOutlined />}
                className="btn-add"
